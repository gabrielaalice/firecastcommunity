...
public class OccurenceFragment extends Fragment {
    ...
    private static Repository repoUser;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.repoUser = new Repository(getContext(),User.class);
    ...
    private static List<Occurrence> ExecuteFilter() {
        List<Integer> filterOccurrences = LoadingTypeOccurrence();
        List<Occurrence> list;

        User user = repoUser.listAll().get(0);
    ...
    private static List<Integer> LoadingTypeOccurrence() {
        User user = repoUser.listAll().get(0);
