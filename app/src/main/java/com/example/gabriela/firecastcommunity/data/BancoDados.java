...
public class BancoDados {
    ...
    public static List<RadioCity> radios(){
            ...
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8000/radio", "Florianópolis"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8028/radio", "Balneario Camboriu"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8001/radio", "Blumenau"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8003/radio", "Canoinhas"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8004/radio", "Chapecó"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8005/radio", "Criciúma"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8006/radio", "Curitibanos"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8007/radio", "Dionisio Cerqueira"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8009/radio", "Brusque"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8013/radio", "Itajai"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8014/radio", "Itapiranga"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8025/radio", "Jaguaruna"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8011/radio", "Joaçaba"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8015/radio", "Lages"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8017/radio", "Maravilha"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8018/radio", "Palma Sola"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8020/radio", "Porto União"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8021/radio", "Rio do Sul"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8022/radio", "São Bento do Sul"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8061/radio", "São Joaquim"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8023/radio", "São Lourenço do Oeste"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8024/radio", "São Miguel do Oeste"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8026/radio", "Videira"));
            radiosUrl.add(new RadioCity("http://radio.cbm.sc.gov.br:8027/radio", "Xanxere"));
            radiosUrl.add(new RadioCity("http://gravacaofns.cbm.sc.gov.br:8000/radio", "Florianópolis"));
            radiosUrl.add(new RadioCity("http://gravacaobcu.cbm.sc.gov.br:8000/radio", "Balneário Camboriú"));
            radiosUrl.add(new RadioCity("http://gravacaobnu.cbm.sc.gov.br:8000/radio", "Blumenau"));
            radiosUrl.add(new RadioCity("http://gravacaobqe.cbm.sc.gov.br:8000/radio", "Brusque"));
            radiosUrl.add(new RadioCity("http://gravacaocbs.cbm.sc.gov.br:8000/radio", "Curitibanos"));
            radiosUrl.add(new RadioCity("http://gravacaocco.cbm.sc.gov.br:8000/radio", "Chapecó"));
            radiosUrl.add(new RadioCity("http://gravacaocni.cbm.sc.gov.br:8000/radio", "Canoinhas"));
            radiosUrl.add(new RadioCity("http://gravacaocua.cbm.sc.gov.br:8000/radio", "Criciúma"));
            radiosUrl.add(new RadioCity("http://gravacaodcq.cbm.sc.gov.br:8000/radio", "Dionísio Cerqueira"));
            radiosUrl.add(new RadioCity("http://gravacaoiai.cbm.sc.gov.br:8000/radio", "Itajaí"));
            radiosUrl.add(new RadioCity("http://gravacaoita.cbm.sc.gov.br:8000/radio", "Itapiranga"));
            radiosUrl.add(new RadioCity("http://gravacaojca.cbm.sc.gov.br:8000/radio", "Joaçaba"));
            radiosUrl.add(new RadioCity("http://gravacaojju.cbm.sc.gov.br:8000/radio", "Jaguaruna"));
            radiosUrl.add(new RadioCity("http://gravacaolgs.cbm.sc.gov.br:8000/radio", "Lages"));
            radiosUrl.add(new RadioCity("http://gravacaomvh.cbm.sc.gov.br:8000/radio", "Maravilha"));
            radiosUrl.add(new RadioCity("http://gravacaopmx.cbm.sc.gov.br:8000/radio", "Palma Sola"));
            radiosUrl.add(new RadioCity("http://gravacaopun.cbm.sc.gov.br:8000/radio", "Porto União"));
            radiosUrl.add(new RadioCity("http://gravacaorsl.cbm.sc.gov.br:8000/radio", "Rio do Sul"));
            radiosUrl.add(new RadioCity("http://gravacaosbs.cbm.sc.gov.br:8000/radio", "São Bento do Sul"));
            radiosUrl.add(new RadioCity("http://gravacaosjq.cbm.sc.gov.br:8000/radio", "São Joaquim"));
            radiosUrl.add(new RadioCity("http://gravacaosge.cbm.sc.gov.br:8000/radio", "São Miguel do Oeste"));
            radiosUrl.add(new RadioCity("http://gravacaosnx.cbm.sc.gov.br:8000/radio", "São Lourenço do Oeste"));
            radiosUrl.add(new RadioCity("http://gravacaotio.cbm.sc.gov.br:8000/radio", "Timbó"));
            radiosUrl.add(new RadioCity("http://gravacaovii.cbm.sc.gov.br:8000/radio", "Videira"));
            radiosUrl.add(new RadioCity("http://gravacaoxxe.cbm.sc.gov.br:8000/radio", "Xanxerê"));
