...
public class DataBaseTemp {
    ...
    public static List<Pair<String, String>> radiosCities(){
            List<Pair<String, String>> radiosUrl = new ArrayList<>();
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8000/radio", "Florianópolis"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8028/radio", "Balneario Camboriu"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8001/radio", "Blumenau"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8003/radio", "Canoinhas"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8004/radio", "Chapecó"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8005/radio", "Criciúma"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8006/radio", "Curitibanos"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8007/radio", "Dionisio Cerqueira"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8009/radio", "Brusque"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8013/radio", "Itajai"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8014/radio", "Itapiranga"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8025/radio", "Jaguaruna"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8011/radio", "Joaçaba"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8015/radio", "Lages"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8017/radio", "Maravilha"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8018/radio", "Palma Sola"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8020/radio", "Porto União"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8021/radio", "Rio do Sul"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8022/radio", "São Bento do Sul"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8061/radio", "São Joaquim"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8023/radio", "São Lourenço do Oeste"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8024/radio", "São Miguel do Oeste"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8026/radio", "Videira"));
            radiosUrl.add(new Pair("http://radio.cbm.sc.gov.br:8027/radio", "Xanxere"));
            radiosUrl.add(new Pair("http://gravacaofns.cbm.sc.gov.br:8000/radio", "Florianópolis"));
            radiosUrl.add(new Pair("http://gravacaobcu.cbm.sc.gov.br:8000/radio", "Balneário Camboriú"));
            radiosUrl.add(new Pair("http://gravacaobnu.cbm.sc.gov.br:8000/radio", "Blumenau"));
            radiosUrl.add(new Pair("http://gravacaobqe.cbm.sc.gov.br:8000/radio", "Brusque"));
            radiosUrl.add(new Pair("http://gravacaocbs.cbm.sc.gov.br:8000/radio", "Curitibanos"));
            radiosUrl.add(new Pair("http://gravacaocco.cbm.sc.gov.br:8000/radio", "Chapecó"));
            radiosUrl.add(new Pair("http://gravacaocni.cbm.sc.gov.br:8000/radio", "Canoinhas"));
            radiosUrl.add(new Pair("http://gravacaocua.cbm.sc.gov.br:8000/radio", "Criciúma"));
            radiosUrl.add(new Pair("http://gravacaodcq.cbm.sc.gov.br:8000/radio", "Dionísio Cerqueira"));
            radiosUrl.add(new Pair("http://gravacaoiai.cbm.sc.gov.br:8000/radio", "Itajaí"));
            radiosUrl.add(new Pair("http://gravacaoita.cbm.sc.gov.br:8000/radio", "Itapiranga"));
            radiosUrl.add(new Pair("http://gravacaojca.cbm.sc.gov.br:8000/radio", "Joaçaba"));
            radiosUrl.add(new Pair("http://gravacaojju.cbm.sc.gov.br:8000/radio", "Jaguaruna"));
            radiosUrl.add(new Pair("http://gravacaolgs.cbm.sc.gov.br:8000/radio", "Lages"));
            radiosUrl.add(new Pair("http://gravacaomvh.cbm.sc.gov.br:8000/radio", "Maravilha"));
            radiosUrl.add(new Pair("http://gravacaopmx.cbm.sc.gov.br:8000/radio", "Palma Sola"));
            radiosUrl.add(new Pair("http://gravacaopun.cbm.sc.gov.br:8000/radio", "Porto União"));
            radiosUrl.add(new Pair("http://gravacaorsl.cbm.sc.gov.br:8000/radio", "Rio do Sul"));
            radiosUrl.add(new Pair("http://gravacaosbs.cbm.sc.gov.br:8000/radio", "São Bento do Sul"));
            radiosUrl.add(new Pair("http://gravacaosjq.cbm.sc.gov.br:8000/radio", "São Joaquim"));
            radiosUrl.add(new Pair("http://gravacaosge.cbm.sc.gov.br:8000/radio", "São Miguel do Oeste"));
            radiosUrl.add(new Pair("http://gravacaosnx.cbm.sc.gov.br:8000/radio", "São Lourenço do Oeste"));
            radiosUrl.add(new Pair("http://gravacaotio.cbm.sc.gov.br:8000/radio", "Timbó"));
            radiosUrl.add(new Pair("http://gravacaovii.cbm.sc.gov.br:8000/radio", "Videira"));
            radiosUrl.add(new Pair("http://gravacaoxxe.cbm.sc.gov.br:8000/radio", "Xanxerê"));
